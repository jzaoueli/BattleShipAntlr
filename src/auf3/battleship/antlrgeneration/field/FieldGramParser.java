...
package auf3.battleship.antlrgeneration.field;
...
public class FieldGramParser extends Parser {
    ...
    public static class FileContext extends ParserRuleContext {
        public List<TerminalNode> Row() {
            return getTokens(FieldGramParser.Row);
        }
        ...
        public TerminalNode Finalrow() {
            return getToken(FieldGramParser.Finalrow, 0);
        }

        public TerminalNode EOF() {
            return getToken(FieldGramParser.EOF, 0);
        }
